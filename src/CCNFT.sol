...
// Dirección para colectar los fondos de las ventas de NFTs.
    function setFundsCollector(address collector) external onlyOwner { // Parámetro, dirección de colector de fondos.
...
// Dirección para colectar las tarifas de transacción.
    function setFeesCollector(address collector) external onlyOwner { // Parámetro, dirección del colector de tarifas.
        require(collector != address(0), "Invalid address"); // La dirección no puede ser la dirección cero (address(0))
